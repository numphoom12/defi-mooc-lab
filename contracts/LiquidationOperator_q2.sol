...
contract LiquidationOperator_q2 is IUniswapV2Callee {
    ...
    IUniswapV2Pair immutable uniswapV2Pair_WBTC_USDT; // WBTC and USDT
    ...
    function operate() external {
        ...
        uint out_WETH = getAmountOut(bal, reserve_WBTC_Pool2, reserve_WETH_Pool2);
        uniswapV2Pair_WBTC_WETH.swap(0, out_WETH, address(this), "");
    ...
    function uniswapV2Call(
        ...
        uint col_WBTC = WBTC.balanceOf(address(this));
        // console.log("collateral(WBTC) =>"col_WBTC);
        ...
        console.log("repay");
        console.log(repay_WBTC,"(WBTC)");
        console.log("\n");

        console.log("profit");
        console.log(col_WBTC-repay_WBTC ,"(WBTC)");
        console.log("\n");
